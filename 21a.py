...
no_allergen_ingredients = deepcopy(all_ingredients) - set.union(*[allergens_d[k] for k in allergens_d])

total = sum([v in no_allergen_ingredients for v in all_line_ingredients])
